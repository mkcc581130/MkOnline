...
class WechatBasic(WechatBase):
    ...
    def get_menu(self):
        ...
        :return: 返回的 JSON 数据包
        """
        return self.request.get('https://api.weixin.qq.com/cgi-bin/menu/get?access_token='+self.access_token)
    ...
    def delete_menu(self):
        ...
        :return: 返回的 JSON 数据包
        """
        return self.request.get('https://api.weixin.qq.com/cgi-bin/menu/delete?access_token='+self.access_token)
    ...
    def _upload_media_py2(self, media_type, media_file, extension=''):
        ...
        return self.request.post(
            url='https://api.weixin.qq.com/cgi-bin/media/upload?access_token='+self.access_token,
            params={
                'type': media_type,
            },
            files={
    ...
    def download_media(self, media_id):
        ...
        return self.request.get(
            'https://api.weixin.qq.com/cgi-bin/media/get?access_token='+self.access_token,
            params={
                'media_id': media_id,
            },
            stream=True,
    ...
    def create_group(self, name):
        ...
        """
        return self.request.post(
            url='https://api.weixin.qq.com/cgi-bin/groups/create?access_token='+self.access_token,
            data={
                'group': {
                    'name': name,
                },
    ...
    def get_groups(self):
        ...
        :return: 返回的 JSON 数据包
        """
        return self.request.get('https://api.weixin.qq.com/cgi-bin/groups/get?access_token='+self.access_token)
    ...
    def get_group_by_id(self, openid):
        ...
        """
        return self.request.post(
            url='https://api.weixin.qq.com/cgi-bin/groups/getid?access_token='+self.access_token,
            data={
                'openid': openid,
            }
        )
    ...
    def update_group(self, group_id, name):
        ...
        """
        return self.request.post(
            url='https://api.weixin.qq.com/cgi-bin/groups/update?access_token='+self.access_token,
            data={
                'group': {
                    'id': int(group_id),
                    'name': name,
    ...
    def move_user(self, user_id, group_id):
        ...
        """
        return self.request.post(
            url='https://api.weixin.qq.com/cgi-bin/groups/members/update?access_token='+self.access_token,
            data={
                'openid': user_id,
                'to_groupid': group_id,
            }
    ...
    def get_address(self, latitude, longitude):
        return self.request.get (
            ...
            data={
                'key': 'QM4BZ-7QCW6-Y5PSV-MKY2Y-IM5XF-NLFGN',
