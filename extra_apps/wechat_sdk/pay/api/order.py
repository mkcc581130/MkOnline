...
from wechat_sdk.utils import timezone
from wechat_sdk.pay.utils import get_external_ip
from wechat_sdk.pay.base import BaseWeChatPayAPI
from wechat_sdk.utils import random_string, to_text
from wechat_sdk.pay.utils import calculate_signature
...
class WeChatOrder(BaseWeChatPayAPI):
    ...
    def create(self, trade_type, body, total_fee, notify_url, client_ip=None,
        ...
        hours_later = now + timedelta(minutes=5)
